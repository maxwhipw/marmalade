...
import app.marmalade.android.ScreenCaptureRequester
...
class ScreenRecordManager(private val context: Context) {
  ...
  @Volatile private var permissionRequester: app.marmalade.android.PermissionRequester? = null
  ...
  fun attachPermissionRequester(requester: app.marmalade.android.PermissionRequester) {
